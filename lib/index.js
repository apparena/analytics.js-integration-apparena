...
AppArena.prototype.onidentify = function (identify) {
    this.enqueue('identify', identify.json())
};
...
AppArena.prototype.enqueue = function (event, msg, fn) {
    ...
    if (this.options.retryQueue) {
        ...
        window.apparena[event].call(msg);
    }
};
